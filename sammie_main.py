...
class MainWindow(QMainWindow):
    ...
    def __init__(self, initial_file=None):
        ...
        print(f"MM-Roto version {__version__}")
    ...
    def _create_main_layout(self):
        ...
        self.main_splitter.setStretchFactor(1, 1)  # main area
    ...
    def _create_playback_controls(self, layout):
        ...
        controls_layout.addStretch(2) #empty space before buttons
    ...
    def on_update_available(self, current_version, latest_version):
        ...
        # Print to console
        print(f"🔔 A new version of MM-roto is available! ({latest_version}) It can be downloaded from the File menu.")
    ...
    def show_about(self):
        ...
        msg.setWindowTitle("About MM-Roto")
        msg.setText(f"MM-roto Version {__version__}")
